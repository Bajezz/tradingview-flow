...
st.title("📊 TradingView Flow — วิเคราะห์สัญญาณจากแท่งถัดไป (b=ขึ้น / r=ลง / g=เสมอ)")
...
# ==============================
# คำนวณตำแหน่ง flow (แท่งต่อเนื่อง)
# ==============================
bar_width = 0.8
scale = 0.5
tops, bottoms = [], []
